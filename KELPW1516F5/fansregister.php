...
<body onload='waitPreloadPage();'>
		<div id='prepage' style='_top: expression(document.documentElement.scrollTop+ document.documentElement.clientHeight-offsetHeight); _left: expression(document.documentElement.scrollLeft+ document.documentElement.clientWidth-offsetWidth); filter: alpha(opacity=75); -moz-opacity: .75; opacity: .75; '>
			<p><img src='images/loading.gif' alt="loading"/><br/>Loading...</p>
		</div>
		<!--end animasi loading-->
				...
				<div id="page" class="grid_12" >
					<div id="page-bg">
						<div id="content" class="grid_9">
							...
							<h3>Fans Registration : </h3><br/>
								<div id="fans">
								<form action="addfans.php" method="post">		
									<label for="fans_name">Username</label>
									<br/><input type="text" name="username" id="username" size="80" class="inputbox" value=""><br /><br />
									<label for="fans_lastname">Password</label>
									<br/><input type="password" name="password" id="password" size="80" label="password" class="inputbox" value=""><br /><br />
									<label for="fans_lastname">Confirm Password</label>
									<br/><input type="password" name="confirmpassword" id="confirmpassword" size="80" label="confirmpassword" class="inputbox" value=""><br /><br />
									<label for="fans_mail">Name</label>
									<br/><input type="text" name="name" id="name" size="80" label="name" class="inputbox" value=""><br /><br />
									<label for="fans_mail">Email</label>
									<br/><input type="text" name="email" id="email" size="80" label="email" class="inputbox" value=""><br /><br />
									<label for="fans_mail">Telepon</label>
									<br/><input type="text" name="telepon" id="telepon" size="80" label="telepon" class="inputbox" value=""><br /><br />
									<label for="fans_mail">Kota Asal</label>
									<br/><input type="text" name="kota" id="kota" size="80" label="kota" class="inputbox" value=""><br /><br />
									<input name="submit" value="submit" class="button" onclick="validate()" type="submit"><input type="reset" name="reset" value="reset" />									
									<br/><br/><strong><a href="fanslogin.php">You have an account already? Log in here</a> </strong>
								</form>	
