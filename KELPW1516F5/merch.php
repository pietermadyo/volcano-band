...
<link rel="stylesheet" type="text/css" media="all" href="merch_style.css" />
...
<body onload='waitPreloadPage();'>
		<div id='prepage' style='_top: expression(document.documentElement.scrollTop+ document.documentElement.clientHeight-offsetHeight); _left: expression(document.documentElement.scrollLeft+ document.documentElement.clientWidth-offsetWidth); filter: alpha(opacity=75); -moz-opacity: .75; opacity: .75; '>
			<p><img src='images/loading.gif' alt="loading"/><br/>Memuat halaman...</p>
		</div>
		<!--end animasi loading-->
					...
					<div id="page-bg">
						<div id="content" class="grid_9">
							<div id="post" class="grid_9 alpha">
								...
								<div id="main_view">
									<img src="images/VolcanoMerch01.jpg" alt="" />
								</div>
							
								<ul class="thumb">
									<li><a href="images/VolcanoMerch01.jpg"><img src="images/VolcanoMerch01.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch02.jpg"><img src="images/VolcanoMerch02.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch03.jpg"><img src="images/VolcanoMerch03.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch04.jpg"><img src="images/VolcanoMerch04.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch05.jpg"><img src="images/VolcanoMerch05.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch06.jpg"><img src="images/VolcanoMerch06.jpg" alt="" /></a></li>
									<li><a href="images/VolcanoMerch07.jpg"><img src="images/VolcanoMerch07.jpg" alt="" /></a></li>
									<li><a href="images/soldout.jpg"><img src="images/soldout.jpg" alt="" /></a></li>
									<li><input name="Buy" value="add to cart" class="button" onclick="validate()" type="button" method="post" action=""/></li>
								</ul>
