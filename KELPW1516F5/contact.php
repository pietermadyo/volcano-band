								...
								<table width="500" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
									<tr>
										<td>
											<table width="500" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
												<tr>
													<td><img src="images/address.png" alt="Addressicon " ><br>	Jl. Babarsari no. 13 <br> Yogyakarta<br>DIY</td>				
													<td><img src="images/emailButton.png" alt="emailicon " >	<br><a href=""> volcano.band@gmail.com</a></td>
													<td><img src="images/con_tel.png" alt="telicon " ><br/>+6281 123123123</td>
												</tr>
											</table>
										</td>
									</tr>
								</table>
								<h4>Send message to this Contact :	</h4>
								<form action="addcontact.php" method="post" >
									<div class="contact_email">
										<label for="contact_name">Enter your name:</label><br />
										<input type="text" name="name" id="name" size="30" class="inputbox" value="" /><br />
										<label for="contact_email">E-mail address:</label><br />
										<input type="text" name="email" id="email" size="30" class="inputbox" value="" /><br />
										<label for="contact_text">Enter your message:</label><br />
										<textarea cols="40" rows="5" name="message" id="message" class="inputbox"></textarea><br /><br />
										<input type="submit" name="send" value="send" class="submit"  /><input type="reset" name="reset" value="reset" />	
									</div>								
								</form>
								<br/>
								<div class="entry">
