					...
					<div id="page-bg">
						<div id="content" class="grid_9">
							...
							<?php
									...
									$result = mysql_query("SELECT * FROM user where role = 'user' order by id_user asc");
									...
									echo "<table >
										...
										while($row = mysql_fetch_array($result))
										{
											  ...
											  "<tr>
												  ...
												  <td><center>" . $row['kota'] . "</center></td>
												  <td><center>" . $row['joindate'] . "</center></td>
												  <td>
													
													  <a href=delete.php?ID=$row[id_user] style='text-decoration:none'
													  onclick=\"return confirm('Apakah anda ingin menghapus $row[username]')\"> <img src='images/action_delete.gif'> </a> 
													  <a href=resetpassword.php?ID=$row[id_user] style='text-decoration:none'
													  onclick=\"return confirm('Apakah anda ingin reset password dari $row[username]')\"> <img src='images/action_edit.gif'> </a>
									...
									//echo "Total Data : <b>$jmldata</b> data <br>"; //menampilkan banyak data
