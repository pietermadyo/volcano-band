...
<html>
    ...
    <body>
		<div class="wrapper">
			<center><h1>WELCOME <br> VOLCANO FANS</h1></center>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="login active" method="post" action="checklogin.php">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
						...
						<div class="bottom">
							...
							<input name="submit" value="login" type="submit" onclick="alert('aaaaa')"/>
