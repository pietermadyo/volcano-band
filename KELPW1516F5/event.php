				...
				<div id="page" class="grid_12" >
					<div id="page-bg">
						<div id="content" class="grid_9">
							<div id="post-event" class="grid_9 alpha">
								<img src="images/Events03.jpg"/>
								<img src="images/Events02.jpg"/>
								<form method="post" action="">
								<h4>Mau nonton...pesan tiketnya segera!!!!</h4>
								<label for="nama">Nama</label>
								<br/><input type="text" name="name" id="name" size="40" label="name" class="inputbox" value=""><br/>
								<label for="email">Email</label>
								<br/><input type="text" name="email" id="email" size="40" label="email" class="inputbox" value=""><br/><br/>
								<input name="Buy" value="pesan tiket" class="button"  type="button" />
								</form>
							</div>		
						</div>	
